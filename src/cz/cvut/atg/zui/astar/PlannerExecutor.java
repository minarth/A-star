...
import cz.cvut.atg.zui.astar.munchmar.Planner;
...
public class PlannerExecutor {
    ...
    private void run(String mapFileName) throws FileNotFoundException {
        ...
        GraphNode origin = newroadGraph.getNodeByNodeId(21291551);
        GraphNode destination = newroadGraph.getNodeByNodeId(256606542);
